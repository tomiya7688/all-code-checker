...
- `tomiya7688/upd-commander-base-design`: strict checker self-check / CI gate の考え方
- `tomiya7688/oop-design-checker`: C# checker core / frontend separation と .NET CI
...
3. CLI self-check entry point against `src/`
